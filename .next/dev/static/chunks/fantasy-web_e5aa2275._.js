...
function NewLeaguePage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const { data: league, error: createError } = await __TURBOPACK__imported__module__$5b$project$5d2f$fantasy$2d$web$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('leagues').insert({
                name: name.trim(),
            ...
            // 创建选秀设置
            await __TURBOPACK__imported__module__$5b$project$5d2f$fantasy$2d$web$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('draft_settings').insert({
                league_id: league.id,
                draft_type: 'snake'
            });
...
//# sourceMappingURL=fantasy-web_e5aa2275._.js.map